...
{
	TIM_SetCompare2(STEERING_ENGINE_TIM,500); //0業
	delay_ms(5000);
	TIM_SetCompare2(STEERING_ENGINE_TIM,950);  //45業
	delay_ms(5000);
	TIM_SetCompare2(STEERING_ENGINE_TIM,1400);  //90業
	delay_ms(5000);
	TIM_SetCompare2(STEERING_ENGINE_TIM,1850);  //135業
	delay_ms(5000);
	TIM_SetCompare2(STEERING_ENGINE_TIM,2300);  //180業,2300胡挫180
	delay_ms(5000);
	
//	TIM_SetCompare2(STEERING_ENGINE_TIM,4500); //0業
//	delay_ms(5000);
//	TIM_SetCompare2(STEERING_ENGINE_TIM,4000);  //45業
//	delay_ms(5000);
//	TIM_SetCompare2(STEERING_ENGINE_TIM,3500);  //90業
//	delay_ms(5000);
//	TIM_SetCompare2(STEERING_ENGINE_TIM,3000);  //135業
//	delay_ms(5000);
//	TIM_SetCompare2(STEERING_ENGINE_TIM,2500);  //180業
//	delay_ms(5000);
}
